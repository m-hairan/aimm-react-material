                ...
                <div className="container-fluid p-0">
                    <div className="brand h-100 d-flex align-items-center">
                        ...
                        <div className="col-lg-5 col-md-12">
                            ...
                            <p className="col-lg-8 col-md-12 p-0 mb-5">The AIMM System is the ONLY way you can get the ONE NUMBER in real time that you need to make correct decisions that will allow you to get to the next level. This one number gets ignored in all estimating and management systems.</p>
